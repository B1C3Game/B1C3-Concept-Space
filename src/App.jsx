...
const concepts = [
  ...
  { name: 'Native language', x: 8, y: 1, z: 0 },
  ...
  return (
    <div className="App">
      ...
      <Plot
        ...
        layout={{
          ...
          scene: {
            ...
            yaxis: {
              title: {
                text: 'Intelligence Required (low → high)',
                font: { size: 18 },
                standoff: 20,
              },
              range: [0, 10],
      ...
      <div style={{ maxWidth: 700, margin: '2em auto', fontSize: '1.08em', background: '#f8f8fa', borderRadius: 8, padding: '1.5em', boxShadow: '0 2px 8px #0001' }}>
        ...
        <b>Y axis:</b> Intelligence Required — The level of cognitive effort or abstraction needed. 0 = low, 10 = high.<br />
